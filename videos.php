				...
				<div class="kopa-header-bottom ">
					<nav class="kopa-main-nav">
						<ul class = "main-menu sf-menu clearfix">
							...
							<li id="menu-item-53" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-53 current-menu-item page_item page-item-5 current_page_item"><a href="videos.php"><span></span>videos</a></li>
        ...
        <div class="row">
            <div class="kopa-main-col col-md-12 col-sm-12 col-xs-12">
				<div class="kopa-entry-list">
					<h1 class="page-title">Dernières vidéos</h1> 
					<ul class="clearfix">
						<li>                
							<article class="entry-item post-5 page type-page status-publish hentry">                     
								...
								<p class="kopa-search">
									...
									<?php
										$r = mysqli_query($db,"SELECT * FROM videos ORDER BY date DESC LIMIT 2");
										while($Line = mysqli_fetch_array($r)){
											extract($Line);
											echo "<iframe width='460' height='615' src='https://www.youtube.com/embed/".$lien."' frameborder='0' allowfullscreen></iframe></br></br></br>";
										}
									?>
									</div>
								</p>
